...
export const MarketplaceSlider = ({ instruments }) => {
  return (
    <div className="flex flex-col justify-center items-center pt-20 animate-in zoom-in duration-1000 ">
      <div className="flex items-center justify-between w-[89%] ">
        <div className="flex flex-col mb-4">
          ...
          <Typography className="text-[2rem] text-gray-900 dark:text-gray-200">
            Explore The instrument Marketplace
          </Typography>
        </div>
      ...
      <Carousel
        ...
        className=" h-[40rem] max-w-[120rem] w-[89%] shadow-lg transition-color duration-700 bg-gray-900 dark:bg-gray-200 shadow-gray-900 dark:shadow-pink-400 dark:shadow-xl"
